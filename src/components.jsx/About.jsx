        ...
        <div className="w-full h-full p-5 text-zinc-300">
            <div className="bg-zinc-800 rounded-md shadow-md p-10">
                ...
                <p className="text-lg leading-7">
                    Welcome to <span className="text-purple-400 font-bold">Web App</span>, your ultimate hub for discovering trending movies, TV shows, and popular content. 
                ...
                <p className="text-lg leading-7 mt-4">
                    Whether you’re a movie enthusiast or a TV series binge-watcher, <span className="text-purple-400 font-bold">Web App</span> brings all the latest updates to your screen. 
